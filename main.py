# this file is used to render homepage and other pages
# Also deals with CRUD
from . import db
...
#Blueprint is used to orgamize files in project. 
# Using this blueprint for main we can acces functions inside this file.
main = Blueprint('main',__name__)

#Setting routes for each function
# this is a decorator
@main.route('/')
def index():
